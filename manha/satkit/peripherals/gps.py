...
class GPS(ManhaSensor):
    ...
    _DEFAULT_LOCATION_FORMATTING = 'ddm'
    ...
    def read(self) -> dict:
        ...
        return {
            ...
            'satcnt': self._gps_parser.satellites_in_use,
            'hdop': self._gps_parser.hdop
        }
    ...
    def getLatitude(self) -> str:
        return self.getLocation['lat']

    def getLongitude(self) -> str:
        return self.getLocation['lng']
    
    def getAltitude(self) -> str:
        return self.getLocation['alt']