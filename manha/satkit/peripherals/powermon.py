...
class PowerMonitor(ManhaSensor):
    ...
    def __init__(
        ...
        shunt_ohms: float = _DEFAULT_SHUNT_OHMS,
        max_expected_amps: float = _DEFAULT_MAX_EXPECTED_AMPS,
    ) -> None:
        ...
        Args:
            ...
            shunt_ohms (float): Shunt resistor value in ohms.
            max_expected_amps (float): Maximum expected current in amps.
        """
        errc = 0
        try:
            self._ina219 = INA219(
