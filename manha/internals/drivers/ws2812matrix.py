...
class PixelColors:
    ...
    BLACK = (0, 0, 0)  # Same as CLEAR
    RED = (MAX_PIXEL_BRIGHTNESS, 0, 0)
    GREEN = (0, MAX_PIXEL_BRIGHTNESS, 0)
    YELLOW = (MAX_PIXEL_BRIGHTNESS, MAX_PIXEL_BRIGHTNESS, 0)
    BLUE = (0, 0, MAX_PIXEL_BRIGHTNESS)
    MAGENTA = (MAX_PIXEL_BRIGHTNESS, 0, MAX_PIXEL_BRIGHTNESS)
    CYAN = (0, MAX_PIXEL_BRIGHTNESS, MAX_PIXEL_BRIGHTNESS)
    WHITE = (MAX_PIXEL_BRIGHTNESS, MAX_PIXEL_BRIGHTNESS, MAX_PIXEL_BRIGHTNESS)
    CLEAR = (0, 0, 0)  # Same as BLACK
